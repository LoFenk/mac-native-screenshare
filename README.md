...
Revision 7 includes automatic system keyboard layout tracking, composed Mac accents, and Option+Up in regular terminals. Existing connections update without restarting sharing, including when a desktop input method is active. See the [keyboard behavior](docs/USAGE.md#keyboard-layouts-accents-and-optionup).
